...
> **O que é este documento.** Um guia de referência, para colar no seu repositório, sobre as boas práticas de **código limpo** (nível micro: como escrever cada função, classe, nome) e **arquitetura limpa** (nível macro: como organizar as dependências de um sistema inteiro). É destilado do cânone estabelecido da engenharia de software — os princípios sistematizados por [Robert C. Martin (*Clean Code*, *Clean Architecture*)](https://medium.com/@ismailbayram.ce/my-book-notes-clean-architecture-by-robert-c-martin-d0d832eb8b66), a leitura Pythônica de [Mariano Anaya (*Clean Code in Python*)](https://github.com/packtpublishing/clean-code-in-python), a aplicação arquitetural de [Sam Keen (*Clean Architecture with Python*)](https://github.com/PacktPublishing/Clean-Architecture-with-Python), e o próprio [Zen of Python (Tim Peters, PEP 20)](https://github.com/python/peps/tree/main).
>
