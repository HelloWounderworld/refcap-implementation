...
Reproduzi `generate_proposal` (linhas 85–122) fielmente, com os defaults **verificados** **[L:** `config/cfg.py:56, 93–102`**]**: `prop_kernel_width=5`, `min_prop_size=3`, `prop_max_cnt=5`, `prop_min_cnt=2`, `prop_score_thr=0.5`.
